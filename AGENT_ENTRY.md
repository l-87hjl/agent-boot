...
|------------|--------|---------|
| `l-87hjl/agent-project-space` | Read/Write | Your workspace |
| `l-87hjl/ai-agent-contract` | Read-Only | Formal specifications |
| `l-87hjl/repo-bridge` | None | Infrastructure (not accessible) |
